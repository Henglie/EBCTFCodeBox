...
export default {
 ...
 // ============================================================
  enigma: {
    ...
    tips: [
      ...
      "破译不需暴力试 $26^{3} \\times \\cdots$ 全空间——利用「字母不映射到自己」+ 已知明文 crib 可大幅剪枝。",
      "配置对不上就全乱：转子顺序、反射器、环设置、初始位、插线板五项缺一不可，题目通常会给全。",
    ],
    aka: ["转轮机", "轮式密码机", "Enigma", "恩尼格玛", "恩尼格玛机", "德军密码机", "转子机", "Enigma machine", "谜机", "转轮密码机", "德国密码机", "转子密码机", "英格玛", "Enigma密码"],
  },
 ...
 // ============================================================
  qqxiuzi_arrow: {
    what: "千千秀字·箭头密码（原称「QQ秀箭头」；符号表出自千千秀字网站，与腾讯 QQ 秀无关）：把文本按字节异或后转成十六进制，再用 16 个箭头符号（←↑→↓ 等）替换 hex 的每一位，可选带密码。",
    principle:
    ...
    tips: ["千千秀字四族（原「QQ秀」名；箭头/花/IPA/字母）算法相同，只是符号表不同，看后缀 `=`/`==` 判单/多字节。"],
    aka: ["QQ秀箭头", "箭头密码", "arrow cipher", "QQ秀·箭头", "qqxiuzi arrow", "QQ秀火星文箭头", "箭头符号密码", "方向箭头密码", "QQ秀加密箭头", "箭头编码", "arrow code", "QQ秀符号密码", "千千秀字箭头", "千千秀字·箭头", "千千秀字箭头密码", "Qianqian Xiuzi arrow", "QQ-Xiu Arrow"],
  },

  qqxiuzi_flower: {
    what: "千千秀字·花密码（原称「QQ秀花」）：和箭头密码同一套算法，只是把 hex 每一位映射成 16 个花朵符号（✻✼✽✾✿❀ 等连续 Unicode 花符）。",
    principle:
    ...
    tips: ["一串连续花朵 emoji 风格符号 + 结尾 `=`/`==`，基本是千千秀字花密码（旧称 QQ秀花密码）。"],
    aka: ["QQ秀花", "花密码", "flower cipher", "QQ秀·花", "qqxiuzi flower", "花朵密码", "花朵符号密码", "QQ秀花朵", "花符密码", "flower code", "QQ秀鲜花密码", "花卉密码", "千千秀字花", "千千秀字·花", "千千秀字花密码", "Qianqian Xiuzi flower", "QQ-Xiu Flower"],
  },

  qqxiuzi_ipa: {
    what: "千千秀字·IPA 密码（原称「QQ秀IPA」）：同套算法，符号表换成 16 个国际音标（IPA）辅音字母（ɐɑɒɓɔɕ 等）。",
    principle:
    ...
    aka: ["QQ秀IPA", "IPA密码", "音标密码", "QQ秀·IPA", "qqxiuzi ipa", "国际音标密码", "IPA cipher", "音标符号密码", "phonetic cipher", "QQ秀音标", "国际音标编码", "辅音符号密码", "千千秀字IPA", "千千秀字·IPA", "千千秀字音标密码", "Qianqian Xiuzi IPA", "QQ-Xiu IPA"],
  },

  qqxiuzi_letter: {
    what: "千千秀字·字母密码（原称「QQ秀字母」）：同套算法，符号表是一组打乱顺序的拉丁字母（TUVWXYZABCNOPQRS）。",
    principle:
    ...
    aka: ["QQ秀字母", "字母密码", "QQ秀·字母", "qqxiuzi letter", "打乱字母密码", "letter cipher", "拉丁字母密码", "乱序字母密码", "QQ秀拉丁字母", "字母替换密码", "letter code", "QQ秀英文密码", "千千秀字字母", "千千秀字·字母", "千千秀字字母密码", "Qianqian Xiuzi letter", "QQ-Xiu Letter"],
  },

  qqxiuzi_braille: {
    what: "千千秀字·盲文密码（原称「QQ秀盲文」）：把字节映射成盲文点字符号（U+2800 区段），有密码时走 hex 编码，无密码时用「1 字符 = 1 字节」的紧凑形式。",
    principle:
    ...
    aka: ["QQ秀盲文", "盲文密码", "braille cipher", "QQ秀·盲文", "qqxiuzi braille", "盲文点字密码", "点字密码", "布莱叶密码", "braille code", "QQ秀点字", "盲文符号密码", "U+2800密码", "千千秀字盲文", "千千秀字·盲文", "千千秀字盲文密码", "Qianqian Xiuzi braille", "QQ-Xiu Braille"],
  },

  qqxiuzi_chinese: {
    what: "千千秀字·汉字密码（原称「QQ秀汉字」）：把字节映射成常用汉字，用三张替换表（单字节/双字节/三字节）覆盖不同码位范围，后缀 `=`/`==`/`===` 区分。",
    principle:
    ...
    aka: ["QQ秀汉字", "汉字密码", "QQ秀·汉字", "qqxiuzi chinese", "中文密码", "常用汉字密码", "chinese cipher", "汉字替换密码", "QQ秀中文", "汉字编码", "chinese code", "QQ秀汉字加密", "千千秀字汉字", "千千秀字·汉字", "千千秀字汉字密码", "Qianqian Xiuzi Chinese", "QQ-Xiu Chinese"],
  },

  qqxiuzi_music: {
    what: "千千秀字·音乐密码（原称「QQ秀音乐」）：把字节转十进制后用 10 个音乐符号（♭♯§∮♪♩♫♬ 等）编码，三种前缀后缀区分短/标准/宽模式。",
    principle:
    ...
    aka: ["QQ秀音乐", "音乐密码", "music cipher", "QQ秀·音乐", "qqxiuzi music", "音乐符号密码", "乐谱密码", "音符密码", "music code", "QQ秀音符", "音乐记号密码", "五线谱密码", "千千秀字音乐", "千千秀字·音乐", "千千秀字音乐密码", "Qianqian Xiuzi music", "QQ-Xiu Music"],
  },
